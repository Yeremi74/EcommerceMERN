...
const AdminPanelNavbar = ({ setActiveMobileMenu }) => {
  return (
    <div className='flex flex-col bg-gray-700 h-screen w-44 fixed text-3xl text-center justify-around items-center text-white shadow-2xl shadow-gray-500 admin-panel-navbar'>
      <Link
